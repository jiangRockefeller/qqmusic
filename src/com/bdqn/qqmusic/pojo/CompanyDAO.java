 ...
 * 
 * @see com.bdqn.qqmusic.pojo.Company
...
public class CompanyDAO extends BaseDAO {
	...
	// property constants
	public static final String CCOMPANY = "ccompany";
	...
	public Company findById(java.lang.Integer id) {
		...
		try {
			Company instance = (Company) getSession().get(
					"com.bdqn.qqmusic.pojo.Company", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Company instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.bdqn.qqmusic.pojo.Company")
