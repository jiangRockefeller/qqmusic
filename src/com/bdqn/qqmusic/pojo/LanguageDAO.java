 ...
 * 
 * @see com.bdqn.qqmusic.pojo.Language
 * @author MyEclipse Persistence Tools
 */

public class LanguageDAO extends BaseDAO {
	private static final Logger log = LoggerFactory
			.getLogger(LanguageDAO.class);
	// property constants
	public static final String LLANGUAGE = "llanguage";
	...
	public Language findById(java.lang.Integer id) {
		...
		try {
			Language instance = (Language) getSession().get(
					"com.bdqn.qqmusic.pojo.Language", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Language instance) {
		...
		try {
			List results = getSession()
					.createCriteria("com.bdqn.qqmusic.pojo.Language")
