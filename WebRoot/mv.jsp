...
<head>
    ...
    <title>QQ音乐 - MV库</title>
    <link rel="canonical" href="//y.qq.com/portal/mv_lib.html" />
...
window.SPD={_timing:{},_start:(new Date()),mark:function(a,b){this._timing[a]=(b||new Date())-this._start}};
    ...
    <link rel="stylesheet" href="css/mv.css-max_age=2592000&v=20160830.css" tppabs="http://y.gtimg.cn/mediastyle/yqq/mv.css?max_age=2592000&v=20160830" />
<script type="text/javascript">SPD.mark(31); // CSS加载完毕</script> 
</head>
<body class="page_mv_all">
       <!-- 头部 S -->
        ...
        <div class="mod_part_detail">
            <div class="part_detail__hd">
                ...
                <div class="part_switch" aria-label="排列方式">
                    ...
                    <a href="javascript:;" class="part_switch__item part_switch__item--right" data-sort="2">最热</a>
                </div>
            </div>
            <div class="mod_mv">
                <ul class="mv_list__list" id="mv_list"></ul>
            </div>
        </div>
...
;(function () {
	require.async("js/v4/mv_lib.js"/*tpa=http://y.qq.com/portal/js/v4/mv_lib.js*/, function( mv_lib ){
		SPD.mark(33);	// JS加载完毕
		mv_lib.init();
	});
})(); 
