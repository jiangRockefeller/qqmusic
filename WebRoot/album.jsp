...
</script><script id="requirenode" async="" src="./QQ音乐 - 专辑库_files/mod.js.下载"></script>
...
<body class="page_album_all os_mac" youdao="bind">
       <!-- 头部 S -->
...
<div class="mod_header">
    <div class="section_inner">
        <h1 class="qqmusic_title"><a href="http://y.qq.com/"><img srcset="images/logo.png" src="./QQ音乐 - 专辑库_files/logo.png" alt="QQ音乐" class="qqmusic_logo"></a></h1>
        <!-- 导航 S -->
        <!-- 
		...
		<li class="top_subnav__item">
		    <a href="http://y.qq.com/portal/album_lib.html#t9=2" class="top_subnav__link top_subnav__link--current">专辑</a>
		</li>
		<li class="top_subnav__item">
            ...
            <div class="search_hot">
                <dl class="search_hot__list" aria-labelledy="search_hot__tit">
                    ...
                    <dd>
                        ...
                        <a href="javascript:;" class="search_hot__link js_smartbox_search js_left" data-name="从你的全世界路过">
                            <span class="search_hot__number">1</span>
                            <span class="search_hot__name">从你的全世界路过</span>
                            <span class="search_hot__listen">14.7万</span>
                        </a>
                        ...
                        <a href="javascript:;" class="search_hot__link js_smartbox_search js_left" data-name="友情岁月">
                            <span class="search_hot__number">3</span>
                            <span class="search_hot__name">友情岁月</span>
                            <span class="search_hot__listen">9.1万</span>
                        </a>
						
                        <a href="javascript:;" class="search_hot__link js_smartbox_search js_left" data-name="流着泪说分手">
                            <span class="search_hot__number">4</span>
                            <span class="search_hot__name">流着泪说分手</span>
                            <span class="search_hot__listen">9万</span>
                        </a>
						
                        <a href="javascript:;" class="search_hot__link js_smartbox_search js_left" data-name="王菲">
                            <span class="search_hot__number">5</span>
                            <span class="search_hot__name">王菲</span>
                            <span class="search_hot__listen">8.9万</span>
                        </a>
            ...
            <div class="search_history">
                <dl class="search_history__list">
                    ...
                    <dd class="search_history__item">
                        <a href="javascript:;" class="search_history__link js_smartbox_search js_right" data-name="beyong">beyong</a>
                        <a href="javascript:;" class="search_history__delete js_smartbox_delete" data-name="beyong"><i class="search_history__icon_delete"></i><span class="icon_txt">删除</span></a>
                    </dd>
	        
                    <dd class="search_history__item">
                        <a href="javascript:;" class="search_history__link js_smartbox_search js_right" data-name="酷爱">酷爱</a>
                        <a href="javascript:;" class="search_history__delete js_smartbox_delete" data-name="酷爱"><i class="search_history__icon_delete"></i><span class="icon_txt">删除</span></a>
                    </dd>
        ...
        <div class="header__opt">
		    ...
		    <a class="top_login__link js_logined" href="http://y.qq.com/portal/profile.html#stat=y_new.top.user_pic" style="display:none;"></a>
    ...
    <div class="main" style="">
        ...
        <div class="mod_tag" id="tag_list">
            ...
            <div class="tag__list">
                ...
                <a href="javascript:;" class="tag__item js_sub_tab tag__item--expand" data-title="类别" data-key="type" data-gid="3">类别<i class="tag__arrow sprite"></i></a>

                <a  href="javascript:;" class="tag__item js_sub_tab" data-title="年代" data-key="year" data-gid="4" onclick=tag__item(this);>年代1<i class="tag__arrow sprite"></i></a>
        ...
        <div class="mod_part_detail">
            <div class="part_detail__hd">
                ...
                <div class="part_switch js_sort" aria-label="排列方式">
                    <a href="javascript:;" class="part_switch__item part_switch__item--left" data-sort="1">最新</a>
                    <a href="javascript:;" class="part_switch__item part_switch__item--right part_switch__item--select" title="最新" data-sort="2">最热</a>
                </div>
            </div>
	...
	<div class="playlist__item_box">
		...
		<h4 class="playlist__title">
			<span class="playlist__title_txt">
				<a href="http://y.qq.com/portal/album/001VHkqi3kBVce.html#stat=y_new.album_lib.album_name" 
				   class="js_album" 
				   data-stat="y_new.album_lib.album_name" 
				   data-albummid="001VHkqi3kBVce" 
				   title="琅琊榜 电视剧原声带">${record.getRname()}</a>
			</span>
		</h4>
		<div class="playlist__author">
				...
				<a href="歌手介绍页" class="js_singer" data-singermid="000FZ2n03q3Mez">${record.getRmainartist()}</a>
		...
		<a href="javascript:;" class="btn_operate_menu js_albumlist_more" data-type="2" data-mid="001VHkqi3kBVce" data-stat="y_new.album_lib.more"><span class="icon_txt">更多</span></a>
	</div>
</li>
</c:forEach>                
...
;(function () {
	require.async("js/v4/album_lib.js", function( album_lib ){
		SPD.mark(33);	// JS加载完毕
		album_lib.init();
	});
})(); 
